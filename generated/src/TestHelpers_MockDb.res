...
and entities = {
  ...
  rewardFxdxVault_AddReward: entityStoreOperations<Types.rewardFxdxVault_AddRewardEntity>,
  @as("RewardFxdxVault_SendReward")
  rewardFxdxVault_SendReward: entityStoreOperations<Types.rewardFxdxVault_SendRewardEntity>,
  @as("RewardFxdxVault_TotalReserves")
  rewardFxdxVault_TotalReserves: entityStoreOperations<Types.rewardFxdxVault_TotalReservesEntity>,
  @as("StakedFxdxVault_Stake")
  stakedFxdxVault_Stake: entityStoreOperations<Types.stakedFxdxVault_StakeEntity>,
  @as("StakedFxdxVault_TotalReserves")
  stakedFxdxVault_TotalReserves: entityStoreOperations<Types.stakedFxdxVault_TotalReservesEntity>,
  @as("StakedFxdxVault_Unstake")
  stakedFxdxVault_Unstake: entityStoreOperations<Types.stakedFxdxVault_UnstakeEntity>,
}
...
let rec makeWithInMemoryStore = (inMemoryStore: IO.InMemoryStore.t) => {
  ...
  let entities = {
    ...
    rewardFxdxVault_AddReward: {
      module(IO.InMemoryStore.RewardFxdxVault_AddReward)->makeStoreOperator(
        ~inMemoryStore,
        ~makeMockDb=makeWithInMemoryStore,
        ~getStore=db => db.rewardFxdxVault_AddReward,
        ~getKey=({id}) => id,
      )
    },
    rewardFxdxVault_SendReward: {
      module(IO.InMemoryStore.RewardFxdxVault_SendReward)->makeStoreOperator(
        ~inMemoryStore,
        ~makeMockDb=makeWithInMemoryStore,
        ~getStore=db => db.rewardFxdxVault_SendReward,
        ~getKey=({id}) => id,
      )
    },
    rewardFxdxVault_TotalReserves: {
      module(IO.InMemoryStore.RewardFxdxVault_TotalReserves)->makeStoreOperator(
        ~inMemoryStore,
        ~makeMockDb=makeWithInMemoryStore,
        ~getStore=db => db.rewardFxdxVault_TotalReserves,
        ~getKey=({id}) => id,
      )
    },
    stakedFxdxVault_Stake: {
      module(IO.InMemoryStore.StakedFxdxVault_Stake)->makeStoreOperator(
        ~inMemoryStore,
        ~makeMockDb=makeWithInMemoryStore,
        ~getStore=db => db.stakedFxdxVault_Stake,
        ~getKey=({id}) => id,
      )
    },
    stakedFxdxVault_TotalReserves: {
      module(IO.InMemoryStore.StakedFxdxVault_TotalReserves)->makeStoreOperator(
        ~inMemoryStore,
        ~makeMockDb=makeWithInMemoryStore,
        ~getStore=db => db.stakedFxdxVault_TotalReserves,
        ~getKey=({id}) => id,
      )
    },
    stakedFxdxVault_Unstake: {
      module(IO.InMemoryStore.StakedFxdxVault_Unstake)->makeStoreOperator(
        ~inMemoryStore,
        ~makeMockDb=makeWithInMemoryStore,
        ~getStore=db => db.stakedFxdxVault_Unstake,
        ~getKey=({id}) => id,
      )
    },
  }
...
let executeMockDbLoadLayer = (
  ...
  let entityExecutors = [
    ...
    makeMockDbEntityExecuter(
      ...
      ~dbReadFn=mockDb.entities.rewardFxdxVault_AddReward.get,
      ~inMemStoreSetFn=IO.InMemoryStore.RewardFxdxVault_AddReward.set,
      ~store=inMemoryStore.rewardFxdxVault_AddReward,
      ~getEntiyId=entity => entity.id,
    ),
    makeMockDbEntityExecuter(
      ~idsToLoad=loadLayer.rewardFxdxVault_SendRewardIdsToLoad,
      ~dbReadFn=mockDb.entities.rewardFxdxVault_SendReward.get,
      ~inMemStoreSetFn=IO.InMemoryStore.RewardFxdxVault_SendReward.set,
      ~store=inMemoryStore.rewardFxdxVault_SendReward,
      ~getEntiyId=entity => entity.id,
    ),
    makeMockDbEntityExecuter(
      ~idsToLoad=loadLayer.rewardFxdxVault_TotalReservesIdsToLoad,
      ~dbReadFn=mockDb.entities.rewardFxdxVault_TotalReserves.get,
      ~inMemStoreSetFn=IO.InMemoryStore.RewardFxdxVault_TotalReserves.set,
      ~store=inMemoryStore.rewardFxdxVault_TotalReserves,
      ~getEntiyId=entity => entity.id,
    ),
    makeMockDbEntityExecuter(
      ~idsToLoad=loadLayer.stakedFxdxVault_StakeIdsToLoad,
      ~dbReadFn=mockDb.entities.stakedFxdxVault_Stake.get,
      ~inMemStoreSetFn=IO.InMemoryStore.StakedFxdxVault_Stake.set,
      ~store=inMemoryStore.stakedFxdxVault_Stake,
      ~getEntiyId=entity => entity.id,
    ),
    makeMockDbEntityExecuter(
      ~idsToLoad=loadLayer.stakedFxdxVault_TotalReservesIdsToLoad,
      ~dbReadFn=mockDb.entities.stakedFxdxVault_TotalReserves.get,
      ~inMemStoreSetFn=IO.InMemoryStore.StakedFxdxVault_TotalReserves.set,
      ~store=inMemoryStore.stakedFxdxVault_TotalReserves,
      ~getEntiyId=entity => entity.id,
    ),
    makeMockDbEntityExecuter(
      ~idsToLoad=loadLayer.stakedFxdxVault_UnstakeIdsToLoad,
      ~dbReadFn=mockDb.entities.stakedFxdxVault_Unstake.get,
      ~inMemStoreSetFn=IO.InMemoryStore.StakedFxdxVault_Unstake.set,
...
let writeFromMemoryStore = (mockDb: t, ~inMemoryStore: IO.InMemoryStore.t) => {
  ...
  mockDb->executeRows(
    ~inMemoryStore,
    ~getStore=self => {self.rewardFxdxVault_AddReward},
    ~getRows=IO.InMemoryStore.RewardFxdxVault_AddReward.values,
    ~setFunction=IO.InMemoryStore.RewardFxdxVault_AddReward.set,
    ~getKey=entity => entity.id,
  )
  mockDb->executeRows(
    ~inMemoryStore,
    ~getStore=self => {self.rewardFxdxVault_SendReward},
    ~getRows=IO.InMemoryStore.RewardFxdxVault_SendReward.values,
    ~setFunction=IO.InMemoryStore.RewardFxdxVault_SendReward.set,
    ~getKey=entity => entity.id,
  )
  mockDb->executeRows(
    ~inMemoryStore,
    ~getStore=self => {self.rewardFxdxVault_TotalReserves},
    ~getRows=IO.InMemoryStore.RewardFxdxVault_TotalReserves.values,
    ~setFunction=IO.InMemoryStore.RewardFxdxVault_TotalReserves.set,
    ~getKey=entity => entity.id,
  )
  mockDb->executeRows(
    ~inMemoryStore,
    ~getStore=self => {self.stakedFxdxVault_Stake},
    ~getRows=IO.InMemoryStore.StakedFxdxVault_Stake.values,
    ~setFunction=IO.InMemoryStore.StakedFxdxVault_Stake.set,
    ~getKey=entity => entity.id,
  )
  mockDb->executeRows(
    ~inMemoryStore,
    ~getStore=self => {self.stakedFxdxVault_TotalReserves},
    ~getRows=IO.InMemoryStore.StakedFxdxVault_TotalReserves.values,
    ~setFunction=IO.InMemoryStore.StakedFxdxVault_TotalReserves.set,
    ~getKey=entity => entity.id,
  )
  mockDb->executeRows(
    ~inMemoryStore,
    ~getStore=self => {self.stakedFxdxVault_Unstake},
    ~getRows=IO.InMemoryStore.StakedFxdxVault_Unstake.values,
    ~setFunction=IO.InMemoryStore.StakedFxdxVault_Unstake.set,
    ~getKey=entity => entity.id,
  )
}
